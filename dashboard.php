...
<head>
    ...
    <title>FHNI - Admin Dashboard</title>
</head>
            ...
            <div class="container-fluid" id="Search">
                ...
                <div class="row" id="searchnav">
                    ...
                    <div class="col-12 rounded" id="centerfield">
                        ...
                        <div class="container-fluid mx-auto" id="dashbuttons">

                            <div class="row mx-auto" id="admindash">

                            <div class="col-sm-3 mx-auto" id = "createbuttons"></div>

                            <div class="col-sm-6 mx-auto">

                                
                                <a href='createuser.php' role='button' class='btn btn-dark btn-lg' id ='sbutton'>CREATE A USER</a>
                                <a href='updatedog.php' role='button' class='btn btn-dark btn-lg' id ='sbutton'>UPDATE A DOG</a>
                            ...
                            <div class="col-sm-3" id = "section2"></div>
