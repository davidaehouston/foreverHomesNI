...
if (isset($_GET['askage'])) {

    $capture = $_GET['askage'];

    $end = "http://dhouston13.lampt.eeecs.qub.ac.uk/7062wdfinal/api/api.php?Age={$capture}";
    $endgetcontents = file_get_contents($end);
    $res = json_decode($endgetcontents,true);
    
} else if (isset($_GET['askbreed'])) { 

    $capture = urlencode($_GET['askbreed']);

    $end = "http://dhouston13.lampt.eeecs.qub.ac.uk/7062wdfinal/api/api.php?dogBreed={$capture}";
    $endgetcontents = file_get_contents($end);
    $res = json_decode($endgetcontents,true);


} else if (isset($_GET['askcoat'])) { 

    $capture = $_GET['askcoat'];

    $end = "http://dhouston13.lampt.eeecs.qub.ac.uk/7062wdfinal/api/api.php?DogCoat={$capture}";
    $endgetcontents = file_get_contents($end);
    $res = json_decode($endgetcontents,true);

} else if (isset($_GET['asksize'])) { 

    $capture = $_GET['asksize'];

    $end = "http://dhouston13.lampt.eeecs.qub.ac.uk/7062wdfinal/api/api.php?DogSize={$capture}";
    $endgetcontents = file_get_contents($end);
    $res = json_decode($endgetcontents,true);

} else if (isset($_GET['askcolour'])) { 

    $capture = urlencode($_GET['askcolour']);

    $end = "http://dhouston13.lampt.eeecs.qub.ac.uk/7062wdfinal/api/api.php?DogColour={$capture}";
    $endgetcontents = file_get_contents($end);
    $res = json_decode($endgetcontents,true);

} else if (isset($_GET['askpostcode'])) { 

    $capture = urlencode($_GET['askpostcode']);

    $end = "http://dhouston13.lampt.eeecs.qub.ac.uk/7062wdfinal/api/api.php?PostCode={$capture}";
    $endgetcontents = file_get_contents($end);
    $res = json_decode($endgetcontents,true);
...
if (isset($_GET['askage'])) {
    ...
    $end = "http://localhost/WD7062/api/api.php?Age={$capture}";
    $endgetcontents = file_get_contents($end);
    $res = json_decode($endgetcontents,true);
    ...
    $end = "http://localhost/WD7062/api/api.php?dogBreed={$capture}";
    $endgetcontents = file_get_contents($end);
    $res = json_decode($endgetcontents,true);
    ...
    $end = "http://localhost/WD7062/api/api.php?DogCoat={$capture}";
    $endgetcontents = file_get_contents($end);
    $res = json_decode($endgetcontents,true);
    ...
    $end = "http://localhost/WD7062/api/api.php?DogSize={$capture}";
    $endgetcontents = file_get_contents($end);
    $res = json_decode($endgetcontents,true);
    ...
    $end = "http://localhost/WD7062/api/api.php?DogColour={$capture}";
    $endgetcontents = file_get_contents($end);
    $res = json_decode($endgetcontents,true);
    ...
    $end = "http://localhost/WD7062/api/api.php?PostCode={$capture}";
    $endgetcontents = file_get_contents($end);
    $res = json_decode($endgetcontents,true);
                    ...
                    <div class="col-12 rounded" id="centerfield">
                        ...
                        <div class="container" id="searchbar">
                            <div class="row" id="sbcontainer">
                                   ...
                                   <div class="col-sm-6" id="searchy">
                                        <input type="search" name="" placeholder="Enter your postcode" id="sbar">
                                        <button class="btn btn-primary" type="button" id="sbutton">Search</button>
                                   </div>
                                   <div class="col-sm-3"></div>
                               </div>
                                ...
                                <div class="dropdown">
                                        ...
                                        <ul class='dropdown-menu' aria-labelledby='dropdownMenuButton1'>
                                            ...
                                            foreach ($anothervarage as $row) {
                                                ...
                                                echo "<li><a class='dropdown-item' href='#'>{$row['Age']}</a></li>";
                                        ...
                                        <ul class='dropdown-menu' aria-labelledby='dropdownMenuButton1'>
                                            ...
                                            <?php
                                                ...
                                                foreach ($anothervarsize as $row) {
                                                    ...
                                                    echo "<li><a class='dropdown-item' href=''>{$row['DogSize']}</a></li>";
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class='dropdown-menu' aria-labelledby='dropdownMenuButton1'>
                                            ...
                                            foreach ($anothervarbreed as $row) {
                                                ...
                                                echo "<li><a class='dropdown-item' href='#'>{$row['DogBreed']}</a></li>";
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            ...
                                            foreach ($anothervarcoat2 as $row) {
                                                ...
                                                echo "<li><a class='dropdown-item' href='#'>{$row['DogCoat']}</a></li>";
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <?php
                                            ...
                                            foreach ($anothervarcolour as $row) {
                                                ...
                                                echo "<li><a class='dropdown-item' href='#'>{$row['DogColour']}</a></li>";
                                ...
                                <div class="dropdown">
                                        ...
                                        <ul class='dropdown-menu' aria-labelledby='dropdownMenuButton1'>
                                            ...
                                            foreach ($anothervarkeepin as $row) {
                                                ...
                                                echo "<li><a class='dropdown-item' href='#'>{$row['KeepIn']}</a></li>";
                            ...
                            <div class="container-fluid" id="resultscont">
                                ...
                                <?php
                                        ...
                                        foreach($res as $row) {
                                            ...
                                            <img src='{$row['breedimg']}' class='card-img-top' alt='https://kwsmdigital.com/wp-content/uploads/2018/06/profile-placeholder-dog-pilot-3.jpg'>
                                                <div class='card-body'>
